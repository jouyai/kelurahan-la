              ...
              <Table>
                <TableBody>
                  <TableRow className="hover:bg-slate-50">
                    ...
                    <TableCell className="text-slate-600">{batas.utara}</TableCell>
                  </TableRow>
                  <TableRow className="hover:bg-slate-50">
                    <TableCell className="font-semibold text-slate-700">Selatan</TableCell>
                    <TableCell className="text-slate-600">{batas.selatan}</TableCell>
                  </TableRow>
                  <TableRow className="hover:bg-slate-50">
                    <TableCell className="font-semibold text-slate-700">Barat</TableCell>
                    <TableCell className="text-slate-600">{batas.barat}</TableCell>
                  </TableRow>
                  <TableRow className="hover:bg-slate-50">
                    <TableCell className="font-semibold text-slate-700">Timur</TableCell>
                    <TableCell className="text-slate-600">{batas.timur}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </CardContent>
