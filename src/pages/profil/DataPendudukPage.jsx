...
const DataPendudukPage = () => {
  // DATA DUMMY STATISTIK (Silakan ganti dengan data real dari Database/API)
  const stats = {
    totalPenduduk: 12540,
    kepalaKeluarga: 3450,
    lakiLaki: 6200,
    perempuan: 6340,
    kepadatan: "5.400 jiwa/km²"
  };
              ...
              <Tabs defaultValue="pekerjaan">
                ...
                <TabsContent value="pendidikan" className="space-y-4">
                  <div className="flex flex-col gap-4">
                    <EduItem label="Belum Sekolah" count="1,200" />
                    <EduItem label="SD / Sederajat" count="2,340" />
                    <EduItem label="SMP / Sederajat" count="2,100" />
                    <EduItem label="SMA / Sederajat" count="3,500" />
                    <EduItem label="Diploma / Sarjana" count="1,400" />
                  </div>
                </TabsContent>
              </Tabs>
            </CardContent>
          ...
          <Card className="md:col-span-2 bg-slate-50 border border-slate-200">
             ...
             <CardContent>
               <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                 {[1,2,3,4,5,6,7,8].map((rw) => (
                   <div key={rw} className="bg-white p-3 rounded-lg border border-slate-200 shadow-sm hover:border-[#0B3D2E] transition-colors">
                     <div className="text-xs text-slate-500 uppercase font-bold">RW 0{rw}</div>
                     <div className="text-lg font-bold text-[#0B3D2E] mt-1">{800 + (rw * 50)}</div>
