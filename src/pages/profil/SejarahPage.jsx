      ...
      <div className="bg-[#0B3D2E] text-white py-12 mb-10 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-slate-200 text-lg max-w-2xl mx-auto">
            Menelusuri jejak langkah perjalanan Kelurahan Lenteng Agung dari
            masa ke masa hingga menjadi kawasan yang maju seperti sekarang.
          </p>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="border-none shadow-md bg-white overflow-hidden">
              ...
              <CardContent className="prose prose-slate max-w-none text-slate-600 leading-relaxed">
                <p>
                  Nama <strong>Lenteng Agung</strong> diyakini berasal dari kata
                  "Klenteng" dan "Agung". Konon pada masa lampau, wilayah ini
                  merupakan tempat persinggahan pedagang Tionghoa yang
                  mendirikan sebuah tempat ibadah (Klenteng) yang cukup besar
                  (Agung) di bantaran Sungai Ciliwung.
                </p>
                <p>
                  Versi lain menyebutkan bahwa nama ini diambil dari karakter
                  tanah dan kontur wilayah yang menyerupai "Lenteng"
                  (lengkungan) sungai yang agung. Terlepas dari berbagai versi
                  sejarah, wilayah ini telah menjadi pemukiman penting sejak era
                  kolonial Belanda karena posisinya yang strategis di jalur
                  menuju Depok dan Bogor.
                </p>
              </CardContent>
            </Card>
