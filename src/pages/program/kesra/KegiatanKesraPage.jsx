...
const getIconComponent = (iconName) => {
  switch (iconName) {
    ...
    case 'Heart': return <Heart className="h-6 w-6 text-green-600" />;
    case 'Gift': return <Gift className="h-6 w-6 text-purple-600" />;
    case 'GraduationCap': return <GraduationCap className="h-6 w-6 text-orange-600" />;
    default: return <Activity className="h-6 w-6 text-slate-600" />;
  }
};
...
export default function KegiatanKesraPage() {
  ...
  const kegiatanList = dbKegiatan.length > 0 ? dbKegiatan.map(k => ({
    ...
    title: k.title,
    desc: k.description,
    jadwal: k.data?.jadwal || "",
    lokasi: k.data?.lokasi || "",
  ...
  })) : [
    {
      ...
      desc: "Layanan kesehatan dasar rutin untuk pemantauan tumbuh kembang balita and cek kesehatan lansia di setiap RW.",
    ...
    },
    {
      ...
      desc: "Distribusi bantuan pangan non-tunai (BPNT) and bantuan sosial tunai (BST) dari pemerintah pusat & daerah.",
    ...
    },
    {
      ...
      desc: "Olahraga bersama warga untuk menjaga kebugaran fisik and mempererat silaturahmi antar tetangga.",
    ...
    },
    {
      ...
      desc: "Program kepedulian sosial berupa pemberian santunan kepada anak yatim piatu and kaum dhuafa.",
    ...
    },
    {
      ...
      desc: "Pelatihan memasak, menjahit, and kerajinan tangan untuk meningkatkan ekonomi keluarga.",
